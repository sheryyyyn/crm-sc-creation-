...
const FORM_FIELDS = [
  ...
  { section: 'Votre projet', mobileTitle: 'Projet', short: 'Votre vision', subtitle: 'Parlez-nous de votre projet et de vos objectifs.', fields: [
    ...
    { label: "Quelle est l'objectif principale de votre projet ? *", name: 'objectif', type: 'tags', required: true, options: ['Promouvoir une offre ou un événement précis', 'Générer des inscriptions avant lancement', 'Présenter mon entreprise, mes services et mes réalisations', 'Vendre mes produits en ligne', 'Refaire ou améliorer mon site actuel', 'Je ne sais pas encore'] },
